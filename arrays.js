...
const checkDogs = (dogsJulia, dogsKate) => {
  ...
  const bothArrays = [...juliaCorrected, ...dogsKate];
  bothArrays.forEach((age, index) => {
    const text =
      age >= 3
...
// ) {
//   console.log("He eats OK");
// } else if (dogOfSarah.curFood > dogOfSarah.recommendedFood * 1.1) {
//   console.log("Eats too much");
// } else {
//   console.log("Eats too little");
// }
console.log(`Sarah's dog eats ${checkFood(dogOfSarah)}`);

// 3. ownerslist

const ownersEatTooMuch = dogs
  .filter((dog) => checkFood(dog) == "too much")
  .flatMap((dog) => dog.owners);
console.log(`${ownersEatTooMuch.join(" and ")}'s dogs eat too much`);

const ownersEatTooLittle = dogs
  .filter((dog) => checkFood(dog) == "too little")
  .flatMap((dog) => dog.owners);
