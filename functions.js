...
const pollButton = document.querySelector("button.poll");
// console.log(pollButton);

pollButton.addEventListener("click", poll.registerAnswer.bind(poll));

const testArray1 = [5, 2, 3];
const testArray2 = [1, 5, 3, 9, 6, 1];

poll.displayResults.call({ answers: testArray1 }, "string");
